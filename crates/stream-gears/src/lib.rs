...
#[pyfunction]
#[pyo3(signature = (video_path, cookie_file, title, tid=171, tag="", copyright, source, desc, dynamic, cover, dolby=0, lossless_music=0, no_reprint=0, open_elec=0, up_close_reply=false, limit=3, desc_v2, dtime, line))]
fn upload(
    py: Python<'_>,
