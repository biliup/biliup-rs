...
#[pyfunction]
#[pyo3(signature = (video_path, cookie_file, title, tid=171, tag=None, copyright=2, source=None, desc=None, dynamic=None, cover=None, dolby=0, lossless_music=0, no_reprint=0, open_elec=0, up_close_reply=false, limit=3, desc_v2=vec![], dtime=None, line=None))]
fn upload(
    py: Python<'_>,
